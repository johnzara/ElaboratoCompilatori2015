...
public abstract class Command extends Absyn {
	...
	public final TypeChecker typeCheck(TypeChecker checker) {
		// si prepara il type-checking del comando specifico e si memorizza il type-checker risultante
		// utile per tenere traccia del type checking eseguito dall'analisi di typeCheckAux()
	...
	protected abstract TypeChecker typeCheckAux(TypeChecker checker);
		//meotodo astratto da implementare nelle sottoclassi TestDeclaration e FixtureDeclaration
	/**
