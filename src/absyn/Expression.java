...
public abstract class Expression extends Absyn {
	...
	protected String label() {
		// se su questa espressione non è ancora stato eseguito il type checking, non viene riportato il suo tipo statico
		if (staticType == null)
			return super.label();
		// altrimenti si riporta il suo tipo statico
		else
