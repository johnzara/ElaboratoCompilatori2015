...
/*
    Viene implementata una lista di bytecode che può essere inserita in un blocco (si veda in translation/Block.java)
*/
public class BytecodeList {
    ...
    public InstructionList generateJavaBytecode(JavaClassGenerator classGen) {
        ...
        // se non sono state aggiunte istruzioni, ne aggiungiamo una fittizia cosi da ritornare sempre una lista non vuota
    	if (result.isEmpty())
