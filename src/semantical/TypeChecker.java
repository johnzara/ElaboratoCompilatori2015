...
// Classe contenitore di ambienti per eseguire l'analisi semantica delle espressioni
...
public class TypeChecker {
	...
	private TypeChecker(Type returnType, Table<TypeAndNumber> env, int varNum, ErrorMsg errorMsg, boolean assertAllowed) {
		...
		this.assertAllowed = assertAllowed; // valutazione dell'assert
	}
	...
	// Il costruttore di typeChecker riceve il tipo di ritorno atteso, un oggetto ErrorMsg e una tabella vuota
	// in cui non c'è ancora nessuna variabile
